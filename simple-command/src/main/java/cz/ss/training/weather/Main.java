...
import cz.ss.training.weather.persist.LocationDAO;
import cz.ss.training.weather.persist.WeatherDAO;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ApplicationContext context = new ClassPathXmlApplicationContext(new String[] {
        "classpath:applicationContext-weather.xml", "classpath:applicationContext-persist.xml" });
